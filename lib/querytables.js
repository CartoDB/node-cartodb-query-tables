...
exports.getAffectedTableNamesFromQuery = function (pg, sql, callback) {
...
exports.getAffectedTablesFromQuery = function (pg, sql, callback) {
    var query =
    ...
    pg.query(query, function handleAffectedTablesAndLastUpdatedTimeRows (err, result) {
        ...
        databaseTables = new DatabaseTables(rows);
        callback(null, databaseTables);
    });
};
